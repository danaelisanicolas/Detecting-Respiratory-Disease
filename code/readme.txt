...
This can be downloaded in either of the links below:
...
- Download the dataset from the links mentioned above and place them on input folder
- Run notebooks according to their number
    -- cnn-part-1-create-subslices-for-each-sound.ipynb
